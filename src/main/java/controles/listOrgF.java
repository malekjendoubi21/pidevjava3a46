...
*/
    ...
    @FXML
    void ajoutOrg(ActionEvent event) throws IOException {
    ...
    @FXML
    void orgF(ActionEvent event) throws IOException {
    ...
    @FXML
    void donB(ActionEvent event) throws IOException {
    ...
    @FXML
    void toDonB(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/listDonB.fxml")));
        Scene scene = ((Node) event.getSource()).getScene();
        scene.setRoot(root);
    }
