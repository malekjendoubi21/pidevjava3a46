...
public class listDon {
    ...
    void initialize() throws SQLException, IOException {
        ...
        //typeComboBox.setItems(donationTypes);

        FilteredList<Don> filteredData = new FilteredList<>(list, b -> true);
        ...
        search.textProperty().addListener((observable, oldValue, newValue) -> {
            filteredData.setPredicate(don -> {
                ...
                return don.getNom().toLowerCase().contains(searchText) ||
                        don.getEmail().toLowerCase().contains(searchText)||
                        don.getType().toLowerCase().contains(searchText)||
                        don.getPrenom().toLowerCase().contains(searchText)||
                        String.valueOf(don.getMontant()).contains(searchText);
            });
        });

        // Bind filtered data to sorted list
